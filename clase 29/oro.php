...
<h1> Calculadora de fibonacci segun número limite </h1><br>
    ...
    <form class="form-centrado" method="POST" action="oro.php">
        <p class="pedir">Ingrese numero limite para saber cociente: <input class="cajatxt" type="text" name="numeros"></p>

        <input class="boton" name="boton" type="submit" value="Ingresar">
